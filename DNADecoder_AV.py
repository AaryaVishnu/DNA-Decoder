...
if Response == 'F' or Response == 'f':
    def SequenceStatsFILE(inputName, outputName):
        ...
        PercentA = (countA / TotalCount) * 100
        PercentT = (countT / TotalCount) * 100
        PercentG = (countG / TotalCount) * 100
        PercentC = (countC / TotalCount) * 100
        ...
        outputfile.write("\n" + "Percentages of Each DNA Nucleotide" + "\n" + "Adenine: " + str(PercentA) + "%" + "\n" + "Thymine: " + str(PercentT) + "%" + "\n" + "Cytosine: " + str(PercentC) + "%" + "\n" + "Guanine: " + str(PercentG) + "%" + "\n")
        ...
        outputfile.write("\n" + "Percentages of Each RNA Nucleotide" + "\n" + "Adenine: " + str(PercentT) + "%" + "\n" + "Uracil: " + str(PercentA) + "%" + "\n" + "Cytosine: " + str(PercentG) + "%" + "\n" + "Guanine: " + str(PercentC) + "%" + "\n")
...
#CONSOLE: 
    ...
    def SequenceStatsCONSOLE(DNASequence):
        ...
        print("Percentages of Each DNA Nucleotide" + "\n" + "Adenine: " + str(PercentA) + "%" + "\n" + "Thymine: " + str(PercentT) + "%" + "\n" + "Cytosine: " + str(PercentC) + "%" + "\n" + "Guanine: " + str(PercentG) + "%" + "\n")
